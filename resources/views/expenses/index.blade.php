...
@section('content')
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
            <h2 class="mb-0"><i class="bi bi-cart"></i> Покупки за свои</h2>
            <a href="{{ route('expense.create') }}" class="btn btn-primary w-100 w-md-auto">
                ...
                <div class="card mb-3 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <h5 class="card-title mb-1">
                                    <i class="bi bi-cart"></i> Покупка #{{ $loop->index + ($expenses->perPage() * ($expenses->currentPage() - 1)) + 1 }}
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-6">
                                <small class="text-muted d-block"><i class="bi bi-calendar"></i> Дата покупки</small>
                        ...
                        <div class="d-grid gap-2">
                            <div class="btn-group" role="group">
                                ...
                                <form action="{{ route('expense.delete', $expense->id) }}" method="POST" style="display: inline; flex: 1;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
