...
<head>
    ...
    <title>Тестирование Платежа</title>
    <!-- Подключаем библиотеки для сжатия (например, LZString) -->
    <script src="https://cdn.jsdelivr.net/npm/lz-string@1.4.4/libs/lz-string.min.js"></script>
</head>
<body>
<h1>Тестирование платежной системы</h1>
...
<script>
    ...
    (function (halyk) {
        ...
        var LZString = function () {
            ...
            var r = String.fromCharCode, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e =
                "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$", t = {}, i = {
                ...
                decompressFromUTF16: function (o) {
                    ...
                    for (t = 2, e = 0; h > e; e++) {
                        m = m << 1 | 1 & t, v == r - 1 ? (v = 0, d.push(n(m)), m = 0) : v++, t
                            >>= 1;
                    }
                    for (; ;) {
                        if (m <<= 1, v == r - 1) {
                    ...
                    var t, i, s, p, u, c, a, l, f = [], h = 4,
                        d = 4, m = 3, v = "", w = [], A = {val: e(0), position: n, index: 1};
                    for (i = 0; 3 > i; i += 1) {
                        f[i] = i;
                    }
                    ...
                    switch (t = p) {
                        ...
                        case 1:
                            for (p = 0, c = Math.pow(2, 16), a = 1; a != c;) {
                                u = A.val & A.position, A.position >>=
                                    1, 0 == A.position && (A.position = n, A.val = e(A.index++)), p |= (u > 0 ? 1 : 0) * a, a <<= 1;
                            }
                            l = r(p);
                            break;
                        case 2:
